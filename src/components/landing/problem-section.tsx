...
const problems = [
  {
    ...
    description:
      '검색량 확인, 경쟁도 분석, 연관 키워드 조사... 네이버 광고 센터를 들락날락하며 감으로 키워드를 고르고 있지 않나요?',
    cost: '월 20시간 낭비',
  },
  {
    icon: Clock,
    ...
    description:
      '리서치, 구조 잡기, 글쓰기, 이미지 배치까지. 한 편에 반나절이 걸리니 주 3회 포스팅도 버겁습니다.',
    cost: '월 48시간 소모',
  },
  {
    icon: TrendingDown,
  ...
  },
  {
    ...
    description:
      '블로그 마케팅 대행사에 맡기면 월 최소 50만원. 그마저도 내 블로그에 최적화된 전략인지 알 수 없습니다.',
