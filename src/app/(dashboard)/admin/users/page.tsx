        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              {/* 헤더 (데스크톱) */}
              <div className="hidden rounded-lg bg-muted p-3 text-xs font-medium text-muted-foreground sm:grid sm:grid-cols-6 sm:gap-4">
              ...
              {data.users.map((user) => (
                <div
                  ...
                  className="cursor-pointer rounded-lg border p-3 transition-colors hover:bg-accent sm:grid sm:grid-cols-6 sm:items-center sm:gap-4"
                >
