...
const UPDATES: UpdateEntry[] = [
  // 2026-03-09
  { date: '2026-03-09', type: 'feat', message: '블로그 지수 v17 — 점수 체계 전면 개편으로 타 사이트 대비 과대평가 문제 해결' },
  { date: '2026-03-09', type: 'feat', message: '방문자 수 점수 반영 — 실제 일방문자 데이터를 활용한 인기도 점수 신설 (5점)' },
  { date: '2026-03-09', type: 'refactor', message: '활동 신뢰도 배점 조정 — 단기 활동(규칙성·최근성) 비중 축소, 장기 신뢰(누적·운영기간) 보강' },
  { date: '2026-03-09', type: 'refactor', message: '사용자 반응 배점 조정 — 추정값(체류시간) 비중 축소, 실측 데이터(댓글·공감·이웃·방문자) 보강' },
  { date: '2026-03-09', type: 'refactor', message: '전 항목 만점 기준 상향 — 쉽게 만점 받던 항목들의 임계값을 업계 수준으로 강화' },
  // 2026-03-05
  { date: '2026-03-05', type: 'fix', message: 'SEO 관련 키워드 점수 정상화 — 태그가 생성되어도 관련 키워드가 항상 0점이던 버그 수정' },
  { date: '2026-03-05', type: 'feat', message: 'AI 콘텐츠 메타데이터 저장 — 메타 설명·자동 최적화 내역·검증 결과 등이 DB에 보존되어 히스토리에서 활용 가능' },
  // 2026-03-04
  { date: '2026-03-04', type: 'feat', message: '크레딧 비용 표시 — 모든 크레딧 소모 버튼에 "(N크레딧)" 비용이 바로 보이고, 사용 후 토스트 알림으로 소모량 확인' },
  { date: '2026-03-04', type: 'feat', message: '콘텐츠 복사 시 자동 발행 — 클립보드 복사와 동시에 상태가 "복사완료"로 변경되고 순위 트래킹 등록 안내' },
  { date: '2026-03-04', type: 'feat', message: '기능 관리 확장 — 관리 가능 기능 9개→12개 (검색 누락 조회·키워드 대량조회·인스타그램 변환 추가), 비활성화 시 사이드바에서 자동 숨김' },
  { date: '2026-03-04', type: 'fix', message: '순위 트래킹 쿨다운 — 동일 키워드 1시간 내 중복 조회 방지로 크레딧 낭비 차단' },
  // 2026-03-03
