...
const SEO_GRADE_TABLE: SeoGradeEntry[] = [
  { minScore: 95, info: { tier: 16, category: '파워', grade: 'Lv.16 파워', label: 'Lv.16 파워', shortLabel: '파워', color: 'amber', badgeColor: GRADE_BADGES[16], description: '네이버 SEO에 완벽히 최적화된 파워 콘텐츠입니다', nextTierScore: null } },
  { minScore: 89, info: { tier: 15, category: '최적화+', grade: 'Lv.15 최적화4+', label: 'Lv.15 최적화4+', shortLabel: '최적화4+', color: 'emerald', badgeColor: GRADE_BADGES[15], description: '최상위 SEO 수준입니다. 파워 등급까지 한 걸음입니다', nextTierScore: 95 } },
  { minScore: 82, info: { tier: 14, category: '최적화+', grade: 'Lv.14 최적화3+', label: 'Lv.14 최적화3+', shortLabel: '최적화3+', color: 'emerald', badgeColor: GRADE_BADGES[14], description: '매우 높은 SEO 최적화 수준입니다', nextTierScore: 89 } },
  { minScore: 76, info: { tier: 13, category: '최적화+', grade: 'Lv.13 최적화2+', label: 'Lv.13 최적화2+', shortLabel: '최적화2+', color: 'teal', badgeColor: GRADE_BADGES[13], description: '경쟁 키워드에서도 우수한 검색 노출이 기대됩니다', nextTierScore: 82 } },
  { minScore: 70, info: { tier: 12, category: '최적화+', grade: 'Lv.12 최적화1+', label: 'Lv.12 최적화1+', shortLabel: '최적화1+', color: 'teal', badgeColor: GRADE_BADGES[12], description: 'SEO 최적화가 우수합니다. 고급 키워드 전략을 시도하세요', nextTierScore: 76 } },
  { minScore: 64, info: { tier: 11, category: '최적화', grade: 'Lv.11 최적화3', label: 'Lv.11 최적화3', shortLabel: '최적화3', color: 'green', badgeColor: GRADE_BADGES[11], description: '안정적인 SEO 최적화 상태입니다. 최적화+ 등급에 도전하세요', nextTierScore: 70 } },
  { minScore: 57, info: { tier: 10, category: '최적화', grade: 'Lv.10 최적화2', label: 'Lv.10 최적화2', shortLabel: '최적화2', color: 'green', badgeColor: GRADE_BADGES[10], description: '양호한 SEO 상태입니다. 콘텐츠 깊이를 더 높여보세요', nextTierScore: 64 } },
  { minScore: 51, info: { tier: 9, category: '최적화', grade: 'Lv.9 최적화1', label: 'Lv.9 최적화1', shortLabel: '최적화1', color: 'lime', badgeColor: GRADE_BADGES[9], description: '기본 SEO가 갖춰져 있습니다. 경쟁 키워드도 도전해보세요', nextTierScore: 57 } },
  { minScore: 45, info: { tier: 8, category: '준최적화', grade: 'Lv.8 준최적화7', label: 'Lv.8 준최적화7', shortLabel: '준최적화7', color: 'blue', badgeColor: GRADE_BADGES[8], description: 'SEO 기본 요소를 보강하면 검색 노출이 향상됩니다', nextTierScore: 51 } },
  { minScore: 38, info: { tier: 7, category: '준최적화', grade: 'Lv.7 준최적화6', label: 'Lv.7 준최적화6', shortLabel: '준최적화6', color: 'blue', badgeColor: GRADE_BADGES[7], description: 'SEO 개선 여지가 많습니다. 주요 항목부터 보완하세요', nextTierScore: 45 } },
  { minScore: 32, info: { tier: 6, category: '준최적화', grade: 'Lv.6 준최적화5', label: 'Lv.6 준최적화5', shortLabel: '준최적화5', color: 'sky', badgeColor: GRADE_BADGES[6], description: '콘텐츠 구조와 키워드 배치를 개선하세요', nextTierScore: 38 } },
  { minScore: 26, info: { tier: 5, category: '준최적화', grade: 'Lv.5 준최적화4', label: 'Lv.5 준최적화4', shortLabel: '준최적화4', color: 'sky', badgeColor: GRADE_BADGES[5], description: '키워드 전략과 콘텐츠 길이부터 개선이 필요합니다', nextTierScore: 32 } },
  { minScore: 20, info: { tier: 4, category: '준최적화', grade: 'Lv.4 준최적화3', label: 'Lv.4 준최적화3', shortLabel: '준최적화3', color: 'indigo', badgeColor: GRADE_BADGES[4], description: 'SEO 기본기를 갖추는 단계입니다. 제목과 소제목부터 최적화하세요', nextTierScore: 26 } },
  { minScore: 13, info: { tier: 3, category: '준최적화', grade: 'Lv.3 준최적화2', label: 'Lv.3 준최적화2', shortLabel: '준최적화2', color: 'indigo', badgeColor: GRADE_BADGES[3], description: '기본적인 SEO 최적화를 시작해보세요', nextTierScore: 20 } },
  { minScore: 7, info: { tier: 2, category: '준최적화', grade: 'Lv.2 준최적화1', label: 'Lv.2 준최적화1', shortLabel: '준최적화1', color: 'violet', badgeColor: GRADE_BADGES[2], description: '콘텐츠 길이와 키워드 포함부터 시작하세요', nextTierScore: 13 } },
  { minScore: 0, info: { tier: 1, category: '일반', grade: 'Lv.1 일반', label: 'Lv.1 일반', shortLabel: '일반', color: 'slate', badgeColor: GRADE_BADGES[1], description: 'SEO 최적화가 거의 되어 있지 않습니다', nextTierScore: 7 } },
]
