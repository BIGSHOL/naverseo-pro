...
export function determineLevelInfo(totalScore: number): BlogLevelInfo {
  ...
  if (totalScore >= 86) return {
    ...
    color: 'emerald', badgeColor: GRADE_BADGES[15], nextTierScore: 93,
  }
  if (totalScore >= 79) return {
    ...
    color: 'emerald', badgeColor: GRADE_BADGES[14], nextTierScore: 86,
  }
  if (totalScore >= 72) return {
    ...
    color: 'teal', badgeColor: GRADE_BADGES[13], nextTierScore: 79,
  }
  if (totalScore >= 66) return {
    ...
    color: 'teal', badgeColor: GRADE_BADGES[12], nextTierScore: 72,
  }
  if (totalScore >= 60) return {
    ...
    color: 'green', badgeColor: GRADE_BADGES[11], nextTierScore: 66,
  }
  if (totalScore >= 54) return {
    ...
    color: 'green', badgeColor: GRADE_BADGES[10], nextTierScore: 60,
  }
  if (totalScore >= 48) return {
    ...
    color: 'lime', badgeColor: GRADE_BADGES[9], nextTierScore: 54,
  }
  ...
  if (totalScore >= 12) return {
    ...
    color: 'indigo', badgeColor: GRADE_BADGES[3], nextTierScore: 18,
  }
  if (totalScore >= 6) return {
    ...
    color: 'violet', badgeColor: GRADE_BADGES[2], nextTierScore: 12,
  }
  return {
    tier: 1, category: '일반', label: 'Lv.1 일반', shortLabel: '일반',
    description: '블로그를 시작한 초기 단계입니다. 꾸준한 포스팅이 핵심입니다.',
    color: 'slate', badgeColor: GRADE_BADGES[1], nextTierScore: 6,
  }
}
