...
export function scorePost(
  ...
  // ── 최종 clamp + 16등급 매핑 (v11.2: SEO_GRADE_TABLE/grading.ts와 동기화) ──
  ...
  if (score >= 97) { tier = 16; category = '파워'; label = '파워' }
  else if (score >= 92) { tier = 15; category = '최적화+'; label = '최적화4+' }
  else if (score >= 86) { tier = 14; category = '최적화+'; label = '최적화3+' }
  else if (score >= 80) { tier = 13; category = '최적화+'; label = '최적화2+' }
  else if (score >= 74) { tier = 12; category = '최적화+'; label = '최적화1+' }
  else if (score >= 68) { tier = 11; category = '최적화'; label = '최적화3' }
  else if (score >= 62) { tier = 10; category = '최적화'; label = '최적화2' }
  else if (score >= 56) { tier = 9; category = '최적화'; label = '최적화1' }
  else if (score >= 50) { tier = 8; category = '준최적화'; label = '준최적화7' }
  else if (score >= 43) { tier = 7; category = '준최적화'; label = '준최적화6' }
  else if (score >= 36) { tier = 6; category = '준최적화'; label = '준최적화5' }
  else if (score >= 29) { tier = 5; category = '준최적화'; label = '준최적화4' }
  else if (score >= 22) { tier = 4; category = '준최적화'; label = '준최적화3' }
  else if (score >= 15) { tier = 3; category = '준최적화'; label = '준최적화2' }
  else if (score >= 8) { tier = 2; category = '준최적화'; label = '준최적화1' }
